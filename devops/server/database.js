use ops_admin
resourceList = [{"id":52,"parentId":null,"sort":0,"name":"登录","code":"/login","type":3,"usable":"1","remarks":"","children":[]},
...
db.SYS_RESOURCE.drop()
db.createCollection('SYS_RESOURCE')
db.SYS_RESOURCE.insert(resourceList)
...
db.SYS_MENU.insert(resourceList)
...
db.SYS_ROLE.insert(resourceList)

const userList = {"id":26,"delFlag":0,"username":"TurnerXi","password":'123456',"email":'290944015@qq.com',"last_login_time":new Date(),'last_login_ip':'127.0.0.1'}
db.SYS_USER.drop()
db.createCollection('SYS_USER')
db.SYS_USER.insert(userList)
